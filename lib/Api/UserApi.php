...
class UserApi
{
     ...
     * Operation loginUser
     *
     * @param  \Swagger\Client\Model\LoginAPI $body body (required)
     *
    ...
    {
        list($response) = $this->loginUserWithHttpInfo($body);
        return $response;
    }
     ...
     *
     * @param  \Swagger\Client\Model\LoginAPI $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\MessageError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
