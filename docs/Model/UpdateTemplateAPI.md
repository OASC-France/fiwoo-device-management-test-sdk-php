...
**organization** | [**AnyOfUpdateTemplateAPIOrganization**](AnyOfUpdateTemplateAPIOrganization.md) | The Organization id that the device belong to | [optional] 
**dataset** | [**AnyOfUpdateTemplateAPIDataset**](AnyOfUpdateTemplateAPIDataset.md) | The Dataset id (under some Organization) that the device belong to | [optional] 
