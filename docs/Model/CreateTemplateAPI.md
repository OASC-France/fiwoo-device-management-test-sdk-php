...
**organization** | [**AnyOfCreateTemplateAPIOrganization**](AnyOfCreateTemplateAPIOrganization.md) | The Organization id that the device belong to | [optional] 
**dataset** | [**AnyOfCreateTemplateAPIDataset**](AnyOfCreateTemplateAPIDataset.md) | The Dataset id (under some Organization) that the device belong to | [optional] 
