...
/**
 * CreateServiceAPI Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateServiceAPI implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateServiceAPI';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
'description' => 'string',
'organization' => 'AnyOfCreateServiceAPIOrganization',
'dataset' => 'AnyOfCreateServiceAPIDataset',
...
'resource' => 'getResource'    ];
     ...
     * Gets organization
     *
     * @return AnyOfCreateServiceAPIOrganization
     */
     ...
     * Sets organization
     *
     * @param AnyOfCreateServiceAPIOrganization $organization The Organization id that the device belong to
     *
     * @return $this
     */
     ...
     * Gets dataset
     *
     * @return AnyOfCreateServiceAPIDataset
     */
     ...
     * Sets dataset
     *
     * @param AnyOfCreateServiceAPIDataset $dataset The Dataset id (under some Organization) that the device belong to
     *
     * @return $this
     */
