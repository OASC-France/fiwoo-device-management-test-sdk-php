 ...
 *
 * @category Class
 * @description Defines what actions can be performed by others over this entity
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PermissionAPI implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PermissionAPI';
...
'read' => 'getRead'    ];
     ...
     * Sets id
     *
     * @param string $id Other entity's id
     *
     * @return $this
     */
     ...
     * Sets write
     *
     * @param bool $write Controlls modifications over the entity
     *
     * @return $this
     */
     ...
     * Sets read
     *
     * @param bool $read Controlls reading over the entity
     *
     * @return $this
     */
